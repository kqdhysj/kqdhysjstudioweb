...
const languageMeta = {
  ...
  lzh: { htmlLang: "lzh-Hans", intlLang: "zh-CN", speechLang: "zh-CN" },
};
...
const siteSearchIndex = [
  ...
  {
    href: "convenience.html#renpy",
    titleKey: "portal.renpy.title",
    excerptKeys: ["portal.renpy.category", "portal.renpy.desc"],
    keywords: ["Ren'Py", "renpy", "visual novel", "视觉小说", "視覺小說", "文字游戏", "文字遊戲", "引擎", "engine"],
  },
  {
...
const translations = {
  "zh-Hans": {
    ...
    "weather.cityPlaceholder": "输入或选择城市",
    ...
    "portal.renpy.category": "创作引擎",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "视觉小说与文字游戏开发引擎",
    ...
    "notice.title": "通知公告",
    "notice.detail": "公文详情",
    "notice.tocAria": "通知公告目录",
    "notice.formatLabel": "格式参考：",
    "notice.formatStandard": "GB/T 9704-2012《党政机关公文格式》",
    "notice.documentsAria": "通知公告公文详情",
    "notice.consult": "咨询",
    "notice.item1": "关于公布工作室统一联系邮箱的通知",
    "notice.item2": "关于公开 B 站主页入口的说明",
    "notice.item3": "关于公开 X 平台账号信息的公告",
    "notice.item4": "关于公开 Facebook 联系渠道的公告",
    "notice.doc.issuer": "kqdhysj工作室文件",
    "notice.doc.number1": "kqdhysj发〔2026〕1号",
    "notice.doc.number2": "kqdhysj发〔2026〕2号",
    "notice.doc.number3": "kqdhysj发〔2026〕3号",
    "notice.doc.number4": "kqdhysj发〔2026〕4号",
    "notice.doc.recipients": "各关注用户、合作伙伴：",
    "notice.doc.email.p1": "为规范工作室信息发布和合作沟通渠道，方便用户、玩家及合作伙伴准确联系 kqdhysj工作室，现将工作室统一联系邮箱公布如下。",
    "notice.doc.email.p2Before": "统一联系邮箱入口为：",
    "notice.doc.email.p2After": "。涉及项目咨询、信息反馈、合作沟通等事项，请优先通过上述入口联系。",
    "notice.doc.email.p3": "本通知自发布之日起执行。",
    "notice.doc.bilibili.p1": "为便于用户了解工作室公开主页信息，现将 kqdhysj工作室 B 站主页入口予以公开。",
    "notice.doc.bilibili.p2Before": "B 站主页入口为：",
    "notice.doc.bilibili.p2After": "。用户可通过该入口查看公开主页信息。",
    "notice.doc.bilibili.p3": "请以本门户发布的链接为准，注意识别来源。",
    "notice.doc.x.p1": "为完善工作室公开联系渠道，现将 kqdhysj工作室 X 平台账号信息公告如下。",
    "notice.doc.x.p2Before": "X 平台账号入口为：",
    "notice.doc.x.p2After": "。用户可通过该入口获取公开账号信息。",
    "notice.doc.x.p3": "相关平台访问体验可能受网络环境影响，请以实际打开结果为准。",
    "notice.doc.facebook.p1": "为补充工作室公开联系渠道，现将 kqdhysj工作室 Facebook 联系入口公告如下。",
    "notice.doc.facebook.p2Before": "Facebook 联系入口为：",
    "notice.doc.facebook.p2After": "。用户可通过该入口查看公开联系页面。",
    "notice.doc.facebook.p3": "涉及正式沟通事项时，仍建议优先通过工作室统一联系邮箱进行确认。",
    "notice.doc.sign": "kqdhysj工作室",
    "notice.doc.date": "2026年7月14日",
    "notice.doc.office": "kqdhysj工作室办公室",
    "notice.doc.printDate": "2026年7月14日印发",
    "access.title": "无障碍服务",
    ...
    "works.title": "作品展示",
    "works.desc": "科幻视觉小说。一艘飞船，两个人。一段无人知晓的故事。",
    "works.card1.title": "星河流转时",
    "works.card1.body": "永恒号深空航行第 97 年。林晨从轮值休眠中被强制唤醒——十一名管理员的屏幕上只有他的亮着绿灯。能量仅剩 72%，飞船在漂流。隔离节点里还有一个意识体在线：他的妹妹林汐。她不是 AI。",
    ...
    "workDetail.desc": "科幻视觉小说。一艘飞船，两个人，一段无人知晓的故事。",
    ...
    "workDetail.intro.p1": "永恒号——人类首艘跨世代星际移民船，目标开普勒-186f。航程预计 600 年。",
    "workDetail.intro.p2": "第 97 年，管理员林晨从休眠中被强制唤醒。飞船在深空漂流，剩下11位管理员和上传者的意识数据消失，能量仅剩 72%。唯一还在的，是隔离节点 7F 里一个半透明的蓝色投影——他的妹妹林汐。她的意识在启程前被上传到船舰数据库。现在她是生活在数字世界的人类。",
    "workDetail.intro.p3": "本作为线性分支叙事视觉小说。玩家以管理员林晨的视角，在一个能量持续流失的飞船里与数字生命的妹妹林汐共度倒计时——通过聊天选择塑造两人的关系走向，每一次回应都在静默累积。",
    "workDetail.features.title": "作品特色",
    "workDetail.feature1": "多结局分支：关键选择累积 love（爱）、hope（希望）、guilt（罪疚）三项隐藏数值，导向四种不同结局。其中之一需要特定数值组合才能触发。",
    "workDetail.feature2": "沉浸式叙事机制：F8 紧急蓝屏伪装、角色感知你 Alt+Tab 切出窗口、系统时间检测生日彩蛋。",
    "workDetail.feature3": "挂机检测：嗯......把游戏挂在后台一会就会触发。",
    "workDetail.feature4": "美味小游戏：通过 Ren'Py Screen 系统将小游戏融入进剧情中。",
    "workDetail.steam.title": "Steam 商店页面待上线",
    "workDetail.steam.desc": "Steam 商店页面将在剧本完成且美术资产到位后上线。以下为计划信息，非最终确定。",
    "workDetail.steam.statusLabel": "商店状态",
    "workDetail.steam.statusValue": "占位：暂未公开",
    "workDetail.steam.priceLabel": "预计价格",
    "workDetail.steam.price": "待定（Steam 国区定价）",
    ...
    "workDetail.steam.note": "提示：当前按钮为占位状态。游戏尚在开发中。",
    ...
    "footer.sitemap": "网站地图",
    "footer.linksAria": "网站纠错与网站地图",
    "home.sidebarAria": "首页侧栏",
    "backtop.aria": "返回顶部",
  ...
  "zh-Hant": {
    ...
    "weather.cityPlaceholder": "輸入或選擇城市",
    "weather.city.shanghai": "上海",
    "weather.city.beijing": "北京",
    ...
    "portal.renpy.category": "創作引擎",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "視覺小說與文字遊戲開發引擎",
    ...
    "notice.title": "通知公告",
    "notice.detail": "公文詳情",
    "notice.tocAria": "通知公告目錄",
    "notice.formatLabel": "格式參考：",
    "notice.formatStandard": "GB/T 9704-2012《黨政機關公文格式》",
    "notice.documentsAria": "通知公告公文詳情",
    "notice.consult": "諮詢",
    ...
    "notice.doc.issuer": "kqdhysj工作室文件",
    "notice.doc.number1": "kqdhysj發〔2026〕1號",
    "notice.doc.number2": "kqdhysj發〔2026〕2號",
    "notice.doc.number3": "kqdhysj發〔2026〕3號",
    "notice.doc.number4": "kqdhysj發〔2026〕4號",
    "notice.doc.recipients": "各關注用戶、合作夥伴：",
    "notice.doc.email.p1": "為規範工作室資訊發布和合作溝通渠道，方便用戶、玩家及合作夥伴準確聯絡 kqdhysj工作室，現將工作室統一聯絡電郵公布如下。",
    "notice.doc.email.p2Before": "統一聯絡電郵入口為：",
    "notice.doc.email.p2After": "。涉及項目諮詢、資訊反饋、合作溝通等事項，請優先通過上述入口聯絡。",
    "notice.doc.email.p3": "本通知自發布之日起執行。",
    "notice.doc.bilibili.p1": "為便於用戶了解工作室公開主頁資訊，現將 kqdhysj工作室 B 站主頁入口予以公開。",
    "notice.doc.bilibili.p2Before": "B 站主頁入口為：",
    "notice.doc.bilibili.p2After": "。用戶可通過該入口查看公開主頁資訊。",
    "notice.doc.bilibili.p3": "請以本門戶發布的連結為準，注意識別來源。",
    "notice.doc.x.p1": "為完善工作室公開聯絡渠道，現將 kqdhysj工作室 X 平台帳號資訊公告如下。",
    "notice.doc.x.p2Before": "X 平台帳號入口為：",
    "notice.doc.x.p2After": "。用戶可通過該入口取得公開帳號資訊。",
    "notice.doc.x.p3": "相關平台訪問體驗可能受網絡環境影響，請以實際打開結果為準。",
    "notice.doc.facebook.p1": "為補充工作室公開聯絡渠道，現將 kqdhysj工作室 Facebook 聯絡入口公告如下。",
    "notice.doc.facebook.p2Before": "Facebook 聯絡入口為：",
    "notice.doc.facebook.p2After": "。用戶可通過該入口查看公開聯絡頁面。",
    "notice.doc.facebook.p3": "涉及正式溝通事項時，仍建議優先通過工作室統一聯絡電郵進行確認。",
    "notice.doc.sign": "kqdhysj工作室",
    "notice.doc.date": "2026年7月14日",
    "notice.doc.office": "kqdhysj工作室辦公室",
    "notice.doc.printDate": "2026年7月14日印發",
    "access.title": "無障礙服務",
    ...
    "works.title": "作品展示",
    "works.desc": "科幻視覺小說。一艘飛船，兩個人。一段無人知曉的故事。",
    "works.card1.title": "星河流轉時",
    "works.card1.body": "永恆號深空航行第 97 年。林晨從輪值休眠中被強制喚醒——十一名管理員的螢幕上只有他的亮著綠燈。能量僅剩 72%，飛船在漂流。隔離節點裡還有一個意識體在線：他的妹妹林汐。她不是 AI。",
    ...
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.desc": "科幻視覺小說。一艘飛船，兩個人，一段無人知曉的故事。",
    ...
    "workDetail.intro.p1": "永恆號——人類首艘跨世代星際移民船，目標開普勒-186f。航程預計 600 年。",
    "workDetail.intro.p2": "第 97 年，管理員林晨從休眠中被強制喚醒。飛船在深空漂流，剩下11位管理員和上傳者的意識資料消失，能量僅剩 72%。唯一還在的，是隔離節點 7F 裡一個半透明的藍色投影——他的妹妹林汐。她的意識在啟程前被上傳到船艦資料庫。現在她是生活在數位世界的人類。",
    "workDetail.intro.p3": "本作為線性分支敘事視覺小說。玩家以管理員林晨的視角，在一艘能量持續流失的飛船裡與數位生命的妹妹林汐共度倒計時——通過聊天選擇塑造兩人的關係走向，每一次回應都在靜默累積。",
    "workDetail.features.title": "作品特色",
    "workDetail.feature1": "多結局分支：關鍵選擇累積 love（愛）、hope（希望）、guilt（罪疚）三項隱藏數值，導向四種不同結局。其中之一需要特定數值組合才能觸發。",
    "workDetail.feature2": "沉浸式敘事機制：F8 緊急藍屏偽裝、角色感知你 Alt+Tab 切出視窗、系統時間檢測生日彩蛋。",
    "workDetail.feature3": "掛機檢測：嗯......把遊戲掛在後台一會就會觸發。",
    "workDetail.feature4": "美味小遊戲：通過 Ren'Py Screen 系統將小遊戲融入進劇情中。",
    "workDetail.steam.title": "Steam 商店頁面待上線",
    "workDetail.steam.desc": "Steam 商店頁面將在劇本完成且美術資產到位後上線。以下為計劃資訊，非最終確定。",
    "workDetail.steam.statusLabel": "商店狀態",
    "workDetail.steam.statusValue": "佔位：暫未公開",
    "workDetail.steam.priceLabel": "預計價格",
    "workDetail.steam.price": "待定（Steam 國區定價）",
    "workDetail.steam.platformLabel": "購買平台",
    "workDetail.steam.platformValue": "Steam",
    "workDetail.steam.dateLabel": "上線時間",
    "workDetail.steam.dateValue": "待公布",
    "workDetail.steam.button": "購買入口待開放",
    "workDetail.steam.note": "提示：目前按鈕為佔位狀態。遊戲尚在開發中。",
    "workDetail.actions.back": "返回作品展示",
    ...
    "footer.sitemap": "網站地圖",
    "footer.linksAria": "網站糾錯與網站地圖",
    "home.sidebarAria": "首頁側欄",
    "backtop.aria": "返回頂部",
  ...
  en: {
    ...
    "weather.cityPlaceholder": "Enter or choose a city",
    ...
    "portal.renpy.category": "Creation engine",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "Visual novel engine for text games",
    ...
    "guide.desc": "Common paths for finding information, opening services, contacting the studio, and using accessibility features.",
    ...
    "guide.card3.title": "Public Information",
    ...
    "notice.detail": "Document Details",
    "notice.tocAria": "Notice directory",
    "notice.formatLabel": "Format reference: ",
    "notice.formatStandard": "GB/T 9704-2012 Official Document Format for Party and Government Organs",
    "notice.documentsAria": "Notice document details",
    ...
    "notice.doc.issuer": "kqdhysj Studio Document",
    "notice.doc.number1": "kqdhysj Doc [2026] No. 1",
    "notice.doc.number2": "kqdhysj Doc [2026] No. 2",
    "notice.doc.number3": "kqdhysj Doc [2026] No. 3",
    "notice.doc.number4": "kqdhysj Doc [2026] No. 4",
    "notice.doc.recipients": "To followers, users, and partners:",
    "notice.doc.email.p1": "To standardize studio information publishing and cooperation channels, and to help users, players, and partners contact kqdhysj Studio accurately, the studio's unified public email address is announced as follows.",
    "notice.doc.email.p2Before": "Unified email contact link: ",
    "notice.doc.email.p2After": ". For project inquiries, feedback, cooperation, and related matters, please use the link above first.",
    "notice.doc.email.p3": "This notice takes effect from the date of publication.",
    "notice.doc.bilibili.p1": "To help users find the studio's public Bilibili page, the official link for kqdhysj Studio is disclosed as follows.",
    "notice.doc.bilibili.p2Before": "Bilibili page link: ",
    "notice.doc.bilibili.p2After": ". Users may view the public page through this link.",
    "notice.doc.bilibili.p3": "Please use the link published on this portal as the reference and pay attention to the source.",
    "notice.doc.x.p1": "To improve the studio's public contact channels, the X account information of kqdhysj Studio is announced as follows.",
    "notice.doc.x.p2Before": "X account link: ",
    "notice.doc.x.p2After": ". Users may view the public account information through this link.",
    "notice.doc.x.p3": "Access to related platforms may be affected by the network environment. Please refer to the actual opening result.",
    "notice.doc.facebook.p1": "To supplement the studio's public contact channels, the Facebook contact link for kqdhysj Studio is announced as follows.",
    "notice.doc.facebook.p2Before": "Facebook contact link: ",
    "notice.doc.facebook.p2After": ". Users may view the public contact page through this link.",
    "notice.doc.facebook.p3": "For formal communication matters, it is still recommended to confirm through the studio's unified public email address first.",
    "notice.doc.sign": "kqdhysj Studio",
    "notice.doc.date": "July 14, 2026",
    "notice.doc.office": "kqdhysj Studio Office",
    "notice.doc.printDate": "Issued on July 14, 2026",
    ...
    "works.desc": "A sci-fi visual novel. One ship, two people, and a story no one else knows.",
    "works.card1.title": "Where Stars Drift",
    "works.card1.body": "In the 97th year of the Eternity's deep-space voyage, Lin Chen is forcibly awakened from rotation sleep. Among eleven administrator screens, only his glows green. Energy has fallen to 72%, and the ship is drifting. One consciousness remains online in the isolation node: his sister Lin Xi. She is not an AI.",
    ...
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.desc": "A sci-fi visual novel. One ship, two people, and a story no one else knows.",
    ...
    "workDetail.intro.p1": "The Eternity is humanity's first cross-generational interstellar migration ship, bound for Kepler-186f. The voyage is expected to take 600 years.",
    "workDetail.intro.p2": "In year 97, administrator Lin Chen is forcibly awakened from hibernation. The ship is drifting through deep space; the consciousness data of the remaining eleven administrators and uploaded passengers has vanished, and only 72% energy remains. The only presence left is a translucent blue projection in isolation node 7F: his sister Lin Xi. Her consciousness was uploaded to the ship database before departure. She is now a human living in a digital world.",
    "workDetail.intro.p3": "This is a linear branching visual novel. Players see through Lin Chen's eyes and spend a countdown aboard an energy-draining ship with his sister Lin Xi, now a digital life. Dialogue choices shape their relationship, and every response accumulates silently.",
    "workDetail.features.title": "Features",
    "workDetail.feature1": "Multiple endings: key choices accumulate three hidden values, love, hope, and guilt, leading to four different endings. One ending requires a specific value combination.",
    "workDetail.feature2": "Immersive narrative systems: an F8 emergency blue-screen disguise, character awareness when you Alt+Tab away, and birthday easter eggs based on system time.",
    "workDetail.feature3": "Idle detection: leave the game in the background for a while and something will trigger.",
    "workDetail.feature4": "Small in-story minigames: Ren'Py Screen systems are used to weave minigames into the story.",
    "workDetail.steam.title": "Steam Store Page Coming Soon",
    "workDetail.steam.desc": "The Steam store page will go live after the script and art assets are ready. The following plan is not final.",
    "workDetail.steam.statusLabel": "Store status",
    "workDetail.steam.statusValue": "Placeholder: not public yet",
    "workDetail.steam.priceLabel": "Estimated price",
    "workDetail.steam.price": "TBD (Steam China regional pricing)",
    "workDetail.steam.platformLabel": "Platform",
    "workDetail.steam.platformValue": "Steam",
    "workDetail.steam.dateLabel": "Launch date",
    "workDetail.steam.dateValue": "To be announced",
    "workDetail.steam.button": "Purchase Link Pending",
    "workDetail.steam.note": "Note: this button is currently a placeholder. The game is still in development.",
    ...
    "footer.linksAria": "Website corrections and sitemap",
    "home.sidebarAria": "Home sidebar",
    ...
    "consult.error": "Submission failed. Please try again later or use the email contact link.",
...
const extraTranslationOverrides = {
  ja: {
    ...
    "hero.panelAria": "セクションリンク",
    "window.title": "セクションリンク",
    ...
    "convenience.desc": "制作、ゲーム、画像編集、各種ツールへのリンクをまとめています。",
    "convenience.gridAria": "便利サービスのリンク",
    "guide.title": "利用ガイド",
    "guide.desc": "情報確認、サービス利用、連絡・フィードバック、アクセシビリティ閲覧の導線を整理しています。",
    "guide.card1.title": "便利サービスリンク",
    "guide.card1.body": "制作、ゲーム、画像、ツールのリンクを個別ページにまとめています。上部の「便利サービス」から確認できます。",
    "guide.card1.link": "リンクを開く",
    "guide.card2.title": "通知公告検索",
    "guide.card2.body": "統一メール、各プラットフォーム、連絡窓口などの正式公告は PDF 公文形式で公開します。",
    "guide.card2.link": "公告を見る",
    "guide.card3.title": "情報公開ページ",
    ...
    "notice.item2": "Bilibili ホームページリンク公開のお知らせ",
    ...
    "workDetail.steam.desc": "Steamストアページは、シナリオと美術素材が整った後に公開予定です。以下は計画情報で、最終確定ではありません。",
    "workDetail.steam.statusLabel": "ストア状態",
    "workDetail.steam.statusValue": "プレースホルダー：未公開",
    "workDetail.steam.priceLabel": "予定価格",
    "workDetail.steam.price": "未定（Steam中国地域価格）",
    "workDetail.steam.platformLabel": "購入プラットフォーム",
    "workDetail.steam.dateLabel": "公開時期",
    "workDetail.steam.dateValue": "未定",
    "workDetail.steam.button": "購入リンクは準備中",
    "workDetail.steam.note": "注意：現在のボタンはプレースホルダーです。ゲームはまだ開発中です。",
    ...
    "sitemap.desc": "サイト内の相対リンクをカテゴリ別にまとめ、アクセシビリティ、フィードバック、連絡リンクも集約します。",
    "sitemap.group1": "主要栏目",
    "sitemap.mainTitle": "コンテンツリンク",
    "sitemap.group2": "サービスリンク",
    ...
    "consult.error": "送信できませんでした。後でもう一度お試しいただくか、メール連絡リンクをご利用ください。",
  ...
  ko: {
    ...
    "convenience.desc": "창작, 게임, 이미지 편집, 도구 링크를 모았습니다.",
    "convenience.gridAria": "편의 서비스 포털",
    "guide.title": "이용 안내",
    "guide.desc": "정보 조회, 서비스 이용, 연락 및 피드백, 접근성 브라우징 경로를 정리했습니다.",
    "guide.card1.title": "편의 서비스 포털",
    "guide.card1.body": "창작, 게임, 이미지, 도구 링크는 별도 상대 페이지로 정리되어 있으며 상단의 편의 서비스에서 확인할 수 있습니다.",
    ...
    "notice.item2": "Bilibili 홈페이지 링크 공개 설명",
    ...
    "workDetail.steam.desc": "Steam 상점 페이지는 시나리오와 미술 애셋이 준비된 뒤 공개될 예정입니다. 아래 계획 정보는 최종 확정이 아닙니다.",
    "workDetail.steam.statusLabel": "상점 상태",
    "workDetail.steam.statusValue": "자리표시자: 아직 공개되지 않음",
    "workDetail.steam.priceLabel": "예상 가격",
    "workDetail.steam.price": "미정(Steam 중국 지역 가격)",
    "workDetail.steam.platformLabel": "구매 플랫폼",
    "workDetail.steam.dateLabel": "공개 시기",
    "workDetail.steam.dateValue": "미정",
    "workDetail.steam.button": "구매 링크 준비 중",
    "workDetail.steam.note": "안내: 현재 버튼은 자리표시자입니다. 게임은 아직 개발 중입니다.",
    ...
    "sitemap.desc": "사이트 내 상대 링크를 섹션별로 모으고 접근성, 피드백, 연락 링크를 함께 정리했습니다.",
    "sitemap.group1": "주요 섹션",
    "sitemap.mainTitle": "콘텐츠 링크",
    "sitemap.group2": "서비스 링크",
    ...
    "consult.error": "제출에 실패했습니다. 나중에 다시 시도하거나 이메일 연락 링크를 이용하세요.",
  ...
  lzh: {
    "meta.title": "kqdhysj工作室资讯门户",
    "meta.description": "kqdhysj工作室之资讯门户，载 glagame、文游、单机游戏与联络之道。",
    "skip": "径至正文",
    "status.aria": "时辰与天气",
    "status.timeLabel": "IP时",
    "status.weatherLabel": "天气",
    "status.weatherAria": "观天气",
    "tools.aria": "语言及无碍之具",
    "language.aria": "易语",
    "language.zhHans": "简体",
    "language.zhHant": "繁体",
    ...
    "tool.contrast": "高反差",
    "tool.reset": "复初",
    "tool.accessHelp": "无碍服务",
    "accessPanel.aria": "无碍览具",
    "accessPanel.title": "无碍览具",
    "accessPanel.opened": "无碍具已展。",
    "accessPanel.closed": "无碍具已阖。",
    "top.email": "邮书相联",
    "brand.aria": "kqdhysj工作室首页",
    "brand.name": "kqdhysj工作室",
    "brand.subtitle": "glagame、文游、单机游戏资讯门户",
    "search.aria": "站内搜寻",
    "search.label": "站内搜寻",
    "search.input": "请输关键字",
    "search.button": "搜",
    "search.empty": "请输所搜之词。",
    "search.none": "未得与「{query}」相关之文。",
    "search.found": "已至与「{query}」相关之处。",
    "search.resultsAria": "搜寻候选",
    "search.resultsTitle": "模糊搜寻所得",
    "search.resultCount": "得相关 {count} 条",
    "nav.aria": "主导航",
    "nav.toggle": "启栏目",
    "nav.home": "首页",
    "nav.overview": "工作室概况",
    ...
    "nav.weather": "便民天气",
    "nav.news": "工作动态",
    "nav.accessibility": "无碍服务",
    "nav.public": "资讯公开",
    "nav.contact": "联络吾等",
    "focus.label": "所重",
    "focus.text": "主 glagame、文游与单机游戏。",
    "hero.kicker": "工作室资讯发布",
    "hero.title": "kqdhysj工作室",
    "hero.body": "围绕 glagame、文游与单机，助其剧情与玩法。",
    "hero.meta.directionLabel": "主向",
    "hero.meta.directionValue": "glagame、文游、单机游戏",
    "hero.meta.updateLabel": "资讯发布",
    "hero.meta.updateValue": "公告、作品服务、联络渠道",
    "hero.meta.accessLabel": "访问之助",
    "hero.meta.accessValue": "无碍、长者版、六语互易",
    "hero.primary": "观作品服务",
    "hero.secondary": "观无碍说明",
    "hero.panelAria": "栏目入口",
    "window.title": "栏目入口",
    "window.directionLabel": "服务所向",
    "window.directionValue": "glagame、文游、单机游戏",
    "window.accessLabel": "无碍状态",
    "window.accessValue": "六语互易、长者版、辅助阅读",
    "window.emailLabel": "联络邮箱",
    "weather.title": "便民天气",
    "weather.desc": "依 IP 自辨所在地，兼搜诸城，取 Open-Meteo API 以供今天天气参考。",
    "weather.cityLabel": "城",
    "weather.cityAria": "输城市名",
    "weather.refresh": "查天气",
    "weather.location": "用今所在",
    "weather.loadingLocation": "天气载入中",
    "weather.loading": "正取天气资料",
    "weather.apparent": "体感温度",
    "weather.humidity": "相对湿度",
    "weather.wind": "风速",
    "weather.updated": "更新时",
    "weather.source": "资料源：Open-Meteo 天气 API；必要时以 wttr.in 备用。",
    "weather.currentLocation": "今所在",
    "weather.geoUnsupported": "此浏览器不支定位，已示预设城市天气。",
    "weather.geoDenied": "不得今所在，已示预设城市天气。",
    "weather.ipLoading": "正依 IP 辨位",
    "weather.ipLocation": "IP定位",
    "weather.ipFallback": "不得 IP 所在，已示预设城市天气及本地时。",
    "weather.error": "天气资料暂不可得，请核城市名或稍后再查。",
    "convenience.title": "便民服务（传送门）",
    "convenience.desc": "辑常用创作、游戏、图像与工具入口。",
    "convenience.gridAria": "便民服务传送门",
    "guide.title": "办事指南",
    "guide.desc": "依资讯查询、服务入口、联络反馈、无碍浏览，列常用路径。",
    "guide.card1.title": "便民传送门",
    "guide.card1.body": "创作、游戏、图像与工具入口已别置相对页，点顶部「便民服务」可入。",
    "guide.card1.link": "入传送门",
    "guide.card2.title": "通知公告查询",
    "guide.card2.body": "统一邮箱、平台主页、联络渠道等正式公告，皆以 PDF 公文发布。",
    "guide.card2.link": "观公告",
    "guide.card3.title": "资讯公开入口",
    "guide.card3.body": "主办、承办、工作室定位与公开资讯，集中展示，便于核验。",
    "guide.card3.link": "观公开资讯",
    "guide.card4.title": "无碍访问支援",
    "guide.card4.body": "有指读、字号调整、高反差与长者版，以便异习之人浏览。",
    "guide.card4.link": "观无碍服务",
    "quick.title": "快捷服务",
    "quick.more": "入",
    "overview.title": "工作室概况",
    "overview.desc": "以叙事设计、玩法规划与独立发布为本，建面向玩家之游戏内容门户。",
    "overview.card1.title": "定位既明",
    "overview.card1.body": "主 glagame、文游与单机游戏，面向剧情体验、文字互动、选择分支与轻量玩法原型而作。",
    "overview.card2.title": "叙事为先",
    "overview.card2.body": "重世界观、人物关系、剧情节奏与玩家选择，使文字、规则、反馈共成游戏体验。",
    "overview.card3.title": "访问友善",
    "overview.card3.body": "备简体、繁体、英文、日文、韩文与文言文切换，并有长者模式与辅助阅读。",
    "services.title": "作品服务",
    "services.desc": "围绕文游与单机项目生涯，供自概念至发布之协作支援。",
    "services.card1.title": "glagame 方案策划",
    "services.card1.body": "理题材、目标玩家、核心体验、玩法循环与版本边界，成可行方案。",
    "services.card2.title": "文游剧情与分支设计",
    "services.card2.body": "规划章节、人物弧光、选择后果、结局路线与文本节奏。",
    "services.card3.title": "单机原型打磨",
    "services.card3.body": "助核心机制验证、关卡节奏、交互说明、可玩版本清单与体验复盘。",
    "services.card4.title": "无碍与发布协同",
    "services.card4.body": "整理公告、版本资讯、玩家说明与多语内容，使作品资讯易读易传。",
    "news.title": "工作动态",
    "news.desc": "集中发布工作室门户、服务与访问支援更新。",
    "news.item3": "简体、繁体、英文、日文、韩文、文言文六语切换已配置",
    "access.title": "无碍服务",
    "access.card4.title": "六语互易",
    "access.card4.body": "备简体中文、繁体中文、英文、日文、韩文与文言文，所选语言存于本机浏览器。",
    "works.title": "作品陈列",
    "works.card1.link": "观详情",
    "workDetail.metaHeading": "基本资讯",
    "workDetail.steam.title": "Steam 商店页待上线",
    "feedback.title": "网站纠错与反馈",
    "sitemap.title": "网站地图与访问之助",
    "contact.title": "联络吾等",
    "consult.title": "咨询表",
    "consult.submit": "提交咨询",
    "footer.feedbackPage": "网站纠错",
    "footer.sitemap": "网站地图",
    "reader.start": "指针辅助阅读已启。鼠标悬停或键盘聚焦文字、按钮、连结时，将朗读其文。",
    "reader.stop": "指针辅助阅读已止。",
    "reader.hoverPrefix": "正读：",
  },
};

const translationCompletionOverrides = {
  ja: {
    "language.zhHans": "簡体字",
    "language.zhHant": "繁体中文",
    "language.lzh": "文言文",
    "weather.cityPlaceholder": "都市を入力または選択",
    "notice.detail": "公文詳細",
    "notice.tocAria": "通知公告目録",
    "notice.formatLabel": "書式参考：",
    "notice.formatStandard": "GB/T 9704-2012『党政機関公文書式』",
    "notice.documentsAria": "通知公告の公文詳細",
    "notice.doc.issuer": "kqdhysjスタジオ文書",
    "notice.doc.number1": "kqdhysj発〔2026〕1号",
    "notice.doc.number2": "kqdhysj発〔2026〕2号",
    "notice.doc.number3": "kqdhysj発〔2026〕3号",
    "notice.doc.number4": "kqdhysj発〔2026〕4号",
    "notice.doc.recipients": "関係ユーザー、パートナー各位：",
    "notice.doc.email.p1": "スタジオの情報発信と協力連絡の窓口を整理し、ユーザー、プレイヤー、パートナーが kqdhysjスタジオへ正確に連絡できるよう、統一連絡メールを次のとおり公開します。",
    "notice.doc.email.p2Before": "統一連絡メールのリンク：",
    "notice.doc.email.p2After": "。プロジェクト相談、情報フィードバック、協力連絡などは、上記リンクを優先してご利用ください。",
    "notice.doc.email.p3": "本通知は公布日から施行します。",
    "notice.doc.bilibili.p1": "ユーザーがスタジオの公開ホームページ情報を確認しやすいよう、kqdhysjスタジオのB站ホームページリンクを公開します。",
    "notice.doc.bilibili.p2Before": "B站ホームページリンク：",
    "notice.doc.bilibili.p2After": "。ユーザーはこのリンクから公開ホームページ情報を確認できます。",
    "notice.doc.bilibili.p3": "本ポータルで公開されたリンクを基準とし、出所の確認にご注意ください。",
    "notice.doc.x.p1": "スタジオの公開連絡窓口を整えるため、kqdhysjスタジオのXアカウント情報を次のとおり公告します。",
    "notice.doc.x.p2Before": "Xアカウントリンク：",
    "notice.doc.x.p2After": "。ユーザーはこのリンクから公開アカウント情報を確認できます。",
    "notice.doc.x.p3": "関連プラットフォームの閲覧状況はネットワーク環境の影響を受ける場合があります。実際の表示結果をご確認ください。",
    "notice.doc.facebook.p1": "スタジオの公開連絡窓口を補足するため、kqdhysjスタジオのFacebook連絡リンクを次のとおり公告します。",
    "notice.doc.facebook.p2Before": "Facebook連絡リンク：",
    "notice.doc.facebook.p2After": "。ユーザーはこのリンクから公開連絡ページを確認できます。",
    "notice.doc.facebook.p3": "正式な連絡事項については、引き続きスタジオの統一連絡メールで確認することを推奨します。",
    "notice.doc.sign": "kqdhysjスタジオ",
    "notice.doc.date": "2026年7月14日",
    "notice.doc.office": "kqdhysjスタジオ事務室",
    "notice.doc.printDate": "2026年7月14日発行",
    "works.desc": "SFビジュアルノベル。一隻の船、二人、誰にも知られていない物語。",
    "works.card1.body": "永遠号の深宇宙航行97年目。林晨は交代休眠から強制的に目覚めさせられます。十一名の管理者画面の中で、緑に点灯しているのは彼のものだけ。エネルギーは72%まで低下し、船は漂流中です。隔離ノードにはもう一つの意識体がオンラインで残っています。彼の妹、林汐です。彼女はAIではありません。",
    "workDetail.desc": "SFビジュアルノベル。一隻の船、二人、誰にも知られていない物語。",
    "portal.touchgal.category": "テキストゲーム",
    "portal.touchgal.title": "TouchGAL",
    "portal.touchgal.desc": "無料のgalgameダウンロードサイト",
    "portal.renpy.category": "制作エンジン",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "ビジュアルノベルとテキストゲーム制作エンジン",
    "portal.steam.category": "ゲームプラットフォーム",
    "portal.steam.title": "Steam オンラインストア",
    "portal.steam.desc": "スタンドアロンゲームとインディーゲームのストア",
    "portal.gequbao.category": "音楽ツール",
    "portal.gequbao.title": "歌曲宝",
    "portal.gequbao.desc": "無料MP3音楽ダウンロード",
    "portal.photopea.category": "画像編集",
    "portal.photopea.title": "Photopea",
    "portal.photopea.desc": "無料オンライン画像・PSD編集ツール",
    "portal.kuro.category": "クラウド鳴潮",
    "portal.kuro.title": "庫洛公式クラウド鳴潮",
    "portal.kuro.desc": "鳴潮をオンラインでプレイできます。",
    "portal.pgyer.category": "Androidアプリ",
    "portal.pgyer.title": "GOインストーラー",
    "portal.pgyer.desc": "Googleサービスコンポーネントをインストールします。",
    "portal.claude.category": "確認ツール",
    "portal.claude.title": "Claude中国ユーザー確認",
    "portal.claude.desc": "サードパーティーツールのリンクです。",
    "guide.card1.tag": "リンク",
    "guide.card2.tag": "公告",
    "guide.card3.tag": "公開",
    "guide.card4.tag": "支援",
    ...
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.meta.platformValue": "Windows / Steam",
    "workDetail.meta.publisherLabel": "パブリッシャー",
    "workDetail.meta.publisherValue": "プレースホルダー：未確定",
    "workDetail.meta.engineValue": "Ren'Py",
    "workDetail.intro.p1": "永遠号は人類初の世代間恒星移民船で、目的地はケプラー186f。航行予定期間は600年です。",
    "workDetail.intro.p2": "第97年、管理者の林晨は休眠から強制的に目覚めさせられます。船は深宇宙を漂流し、残る十一名の管理者とアップロード者の意識データは消失、エネルギーは72%しか残っていません。唯一残っているのは、隔離ノード7Fに映る半透明の青い投影、彼の妹の林汐です。彼女の意識は出航前に船内データベースへアップロードされていました。今の彼女はデジタル世界で生きる人間です。",
    "workDetail.intro.p3": "本作は線形分岐型のビジュアルノベルです。プレイヤーは管理者・林晨の視点から、エネルギーが失われ続ける船内で、デジタル生命となった妹・林汐とカウントダウンを過ごします。会話の選択が二人の関係を形作り、すべての返答が静かに積み重なっていきます。",
    "workDetail.feature1": "マルチエンディング分岐：重要な選択で love、hope、guilt の三つの隠し値が蓄積し、四つの異なる結末へ分岐します。その一つは特定の数値組み合わせでのみ発生します。",
    "workDetail.feature2": "没入型の物語演出：F8緊急ブルースクリーン偽装、Alt+Tabでウィンドウを離れたことをキャラクターが感知する演出、システム時刻による誕生日イースターエッグ。",
    "workDetail.feature3": "放置検知：ゲームをしばらくバックグラウンドに置くと、何かが発生します。",
    "workDetail.feature4": "小さな物語内ミニゲーム：Ren'Py Screenシステムでミニゲームを物語に組み込みます。",
    "workDetail.steam.platformValue": "Steam",
    "contact.biliLabel": "B站",
    "footer.linksAria": "サイト修正とサイトマップ",
    "home.sidebarAria": "ホームサイドバー",
  },
  ko: {
    "language.zhHans": "간체",
    "language.zhHant": "번체",
    "language.lzh": "문언문",
    "weather.cityPlaceholder": "도시 입력 또는 선택",
    "notice.detail": "공문 상세",
    "notice.tocAria": "공지사항 목차",
    "notice.formatLabel": "형식 참고: ",
    "notice.formatStandard": "GB/T 9704-2012 당정기관 공문 형식",
    "notice.documentsAria": "공지사항 공문 상세",
    "notice.doc.issuer": "kqdhysj 스튜디오 문서",
    "notice.doc.number1": "kqdhysj 발〔2026〕1호",
    "notice.doc.number2": "kqdhysj 발〔2026〕2호",
    "notice.doc.number3": "kqdhysj 발〔2026〕3호",
    "notice.doc.number4": "kqdhysj 발〔2026〕4호",
    "notice.doc.recipients": "관심 사용자 및 협력 파트너 여러분:",
    "notice.doc.email.p1": "스튜디오의 정보 공개와 협력 소통 채널을 표준화하고 사용자, 플레이어, 협력 파트너가 kqdhysj 스튜디오에 정확히 연락할 수 있도록 통합 연락 이메일을 다음과 같이 공개합니다.",
    "notice.doc.email.p2Before": "통합 연락 이메일 링크: ",
    "notice.doc.email.p2After": ". 프로젝트 문의, 정보 피드백, 협력 소통 등은 위 링크를 우선 이용해 주십시오.",
    "notice.doc.email.p3": "본 공지는 게시일부터 시행됩니다.",
    "notice.doc.bilibili.p1": "사용자가 스튜디오 공개 홈페이지 정보를 확인하기 쉽도록 kqdhysj 스튜디오의 B站 홈페이지 링크를 공개합니다.",
    "notice.doc.bilibili.p2Before": "B站 홈페이지 링크: ",
    "notice.doc.bilibili.p2After": ". 사용자는 이 링크를 통해 공개 홈페이지 정보를 확인할 수 있습니다.",
    "notice.doc.bilibili.p3": "본 포털에 게시된 링크를 기준으로 삼고 출처 확인에 유의하십시오.",
    "notice.doc.x.p1": "스튜디오의 공개 연락 채널을 보완하기 위해 kqdhysj 스튜디오의 X 계정 정보를 다음과 같이 공지합니다.",
    "notice.doc.x.p2Before": "X 계정 링크: ",
    "notice.doc.x.p2After": ". 사용자는 이 링크를 통해 공개 계정 정보를 확인할 수 있습니다.",
    "notice.doc.x.p3": "관련 플랫폼 접속 경험은 네트워크 환경의 영향을 받을 수 있으므로 실제 열람 결과를 기준으로 하십시오.",
    "notice.doc.facebook.p1": "스튜디오의 공개 연락 채널을 보충하기 위해 kqdhysj 스튜디오의 Facebook 연락 링크를 다음과 같이 공지합니다.",
    "notice.doc.facebook.p2Before": "Facebook 연락 링크: ",
    "notice.doc.facebook.p2After": ". 사용자는 이 링크를 통해 공개 연락 페이지를 확인할 수 있습니다.",
    "notice.doc.facebook.p3": "공식 소통 사항은 여전히 스튜디오 통합 연락 이메일을 우선 사용해 확인하는 것을 권장합니다.",
    "notice.doc.sign": "kqdhysj 스튜디오",
    "notice.doc.date": "2026년 7월 14일",
    "notice.doc.office": "kqdhysj 스튜디오 사무실",
    "notice.doc.printDate": "2026년 7월 14일 발행",
    "works.desc": "SF 비주얼 노벨. 우주선 한 척, 두 사람, 아무도 모르는 이야기.",
    "works.card1.body": "영원호의 심우주 항해 97년째. 린천은 교대 휴면에서 강제로 깨어납니다. 열한 명의 관리자 화면 중 초록불이 켜진 것은 그의 화면뿐입니다. 에너지는 72%만 남았고, 우주선은 표류 중입니다. 격리 노드에는 하나의 의식체가 아직 온라인 상태입니다. 그의 여동생 린시입니다. 그녀는 AI가 아닙니다.",
    "workDetail.desc": "SF 비주얼 노벨. 우주선 한 척, 두 사람, 아무도 모르는 이야기.",
    "portal.touchgal.category": "텍스트 게임",
    "portal.touchgal.title": "TouchGAL",
    "portal.touchgal.desc": "무료 galgame 다운로드 사이트",
    "portal.renpy.category": "제작 엔진",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "비주얼 노벨과 텍스트 게임 제작 엔진",
    "portal.steam.category": "게임 플랫폼",
    "portal.steam.title": "Steam 온라인 스토어",
    "portal.steam.desc": "싱글 플레이와 인디 게임 스토어",
    "portal.gequbao.category": "음악 도구",
    "portal.gequbao.title": "Gequbao",
    "portal.gequbao.desc": "무료 MP3 음악 다운로드",
    "portal.photopea.category": "이미지 편집",
    "portal.photopea.title": "Photopea",
    "portal.photopea.desc": "무료 온라인 이미지 및 PSD 편집 도구",
    "portal.kuro.category": "클라우드 명조",
    "portal.kuro.title": "쿠로 공식 클라우드 명조",
    "portal.kuro.desc": "명조를 온라인으로 플레이할 수 있습니다.",
    "portal.pgyer.category": "Android 앱",
    "portal.pgyer.title": "GO 설치기",
    "portal.pgyer.desc": "Google 서비스 구성 요소를 설치합니다.",
    "portal.claude.category": "확인 도구",
    "portal.claude.title": "Claude 중국 사용자 확인",
    "portal.claude.desc": "타사 도구 접속 페이지입니다.",
    "guide.card1.tag": "포털",
    "guide.card2.tag": "공지",
    "guide.card3.tag": "공개",
    "guide.card4.tag": "지원",
    ...
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.meta.platformValue": "Windows / Steam",
    "workDetail.meta.publisherLabel": "퍼블리셔",
    "workDetail.meta.publisherValue": "자리표시자: 추후 확정",
    "workDetail.meta.engineValue": "Ren'Py",
    "workDetail.intro.p1": "영원호는 인류 최초의 세대 간 성간 이민선이며, 목표지는 케플러-186f입니다. 항해 기간은 약 600년으로 예정되어 있습니다.",
    "workDetail.intro.p2": "97년째, 관리자 린천은 휴면에서 강제로 깨어납니다. 우주선은 심우주를 표류하고 있고, 남은 열한 명의 관리자와 업로드된 승객의 의식 데이터는 사라졌으며, 에너지는 72%만 남았습니다. 유일하게 남아 있는 것은 격리 노드 7F의 반투명한 푸른 투영, 그의 여동생 린시입니다. 그녀의 의식은 출항 전 함선 데이터베이스에 업로드되었습니다. 지금 그녀는 디지털 세계에 사는 인간입니다.",
    "workDetail.intro.p3": "본작은 선형 분기형 비주얼 노벨입니다. 플레이어는 관리자 린천의 시점으로, 에너지가 계속 줄어드는 우주선 안에서 디지털 생명이 된 여동생 린시와 카운트다운을 함께 보냅니다. 대화 선택은 두 사람의 관계 방향을 만들고, 모든 응답은 조용히 누적됩니다.",
    "workDetail.feature1": "멀티 엔딩 분기: 핵심 선택은 love, hope, guilt 세 가지 숨겨진 수치를 누적하며 네 가지 다른 결말로 이어집니다. 그중 하나는 특정 수치 조합이 필요합니다.",
    "workDetail.feature2": "몰입형 서사 장치: F8 긴급 블루스크린 위장, Alt+Tab으로 창을 벗어난 것을 캐릭터가 감지하는 연출, 시스템 시간 기반 생일 이스터에그.",
    "workDetail.feature3": "방치 감지: 게임을 백그라운드에 잠시 두면 무언가가 발생합니다.",
    "workDetail.feature4": "이야기 속 작은 미니게임: Ren'Py Screen 시스템으로 미니게임을 서사에 통합합니다.",
    "workDetail.steam.platformValue": "Steam",
    "contact.biliLabel": "B站",
    "footer.linksAria": "웹사이트 수정과 사이트맵",
    "home.sidebarAria": "홈 사이드바",
  },
  lzh: {
    "language.zhHans": "简体",
    "weather.cityPlaceholder": "输城名或择城",
    "weather.city.shanghai": "上海",
    "weather.city.beijing": "北京",
    "weather.city.guangzhou": "广州",
    "weather.city.chengdu": "成都",
    "weather.city.newyork": "纽约",
    "weather.clear": "晴",
    "weather.mainlyClear": "大晴",
    "weather.partlyCloudy": "微云",
    "weather.overcast": "阴",
    "weather.fog": "雾",
    "weather.drizzle": "细雨",
    "weather.freezingDrizzle": "冻霖",
    "weather.rain": "雨",
    "weather.freezingRain": "冻雨",
    "weather.snow": "雪",
    "weather.snowGrains": "霰",
    "weather.showers": "骤雨",
    "weather.snowShowers": "骤雪",
    "weather.thunderstorm": "雷雨",
    "weather.unknown": "天候未详",
    "portal.touchgal.category": "文游之资",
    "portal.touchgal.title": "TouchGAL",
    "portal.touchgal.desc": "galgame 免费下载之所",
    "portal.renpy.category": "创作引擎",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "视觉小说与文字游戏开发之具",
    "portal.steam.category": "游戏平台",
    "portal.steam.title": "Steam 线上商店",
    "portal.steam.desc": "单机与独立游戏购取之所",
    "portal.gequbao.category": "乐曲之具",
    "portal.gequbao.title": "歌曲宝",
    "portal.gequbao.desc": "MP3 乐曲免费下载",
    "portal.photopea.category": "图像修编",
    "portal.photopea.title": "Photopea",
    "portal.photopea.desc": "线上图像与 PSD 修编之具",
    "portal.kuro.category": "云鸣潮",
    "portal.kuro.title": "库洛官方云鸣潮",
    "portal.kuro.desc": "可线上游鸣潮。",
    "portal.pgyer.category": "安卓应用",
    "portal.pgyer.title": "GO 安装器",
    "portal.pgyer.desc": "安 Google 服务套件。",
    "portal.claude.category": "检验之具",
    "portal.claude.title": "Claude 中国用户检验",
    "portal.claude.desc": "第三方器具入口。",
    "guide.card1.tag": "门",
    "guide.card2.tag": "告",
    "guide.card3.tag": "公",
    "guide.card4.tag": "助",
    ...
    "quick.tag7": "索引",
    "news.more": "更多",
    "news.item1": "门户已归 glagame、文游、单机之向",
    "news.item2": "无碍栏既开，支指读与长者版",
    "news.item4": "主办、承办之资讯已公示",
    "notice.title": "告示",
    "notice.detail": "公文详览",
    "notice.tocAria": "告示目录",
    "notice.formatLabel": "格式所本：",
    "notice.formatStandard": "GB/T 9704-2012《党政机关公文格式》",
    "notice.documentsAria": "告示公文详览",
    "notice.consult": "咨询",
    "notice.item1": "公布工作室一统联络邮书之告",
    "notice.item2": "公开 B 站首页入口之说",
    "notice.item3": "公开 X 平台帐号资讯之告",
    "notice.item4": "公开 Facebook 联络途径之告",
    "notice.doc.issuer": "kqdhysj工作室文件",
    "notice.doc.number1": "kqdhysj发〔2026〕一号",
    "notice.doc.number2": "kqdhysj发〔2026〕二号",
    "notice.doc.number3": "kqdhysj发〔2026〕三号",
    "notice.doc.number4": "kqdhysj发〔2026〕四号",
    "notice.doc.recipients": "诸关注者、合作诸方：",
    "notice.doc.email.p1": "为一工作室资讯发布与合作沟通之道，俾用者、玩家及合作诸方得准确联络 kqdhysj工作室，今公布工作室一统联络邮书如下。",
    "notice.doc.email.p2Before": "一统联络邮书入口为：",
    "notice.doc.email.p2After": "。凡项目咨询、资讯反馈、合作沟通等事，请先由上列入口联络。",
    "notice.doc.email.p3": "本告自发布之日起行。",
    "notice.doc.bilibili.p1": "为便用者知工作室公开主页资讯，今公开 kqdhysj工作室 B 站主页入口。",
    "notice.doc.bilibili.p2Before": "B 站主页入口为：",
    "notice.doc.bilibili.p2After": "。用者可由此入口观公开主页资讯。",
    "notice.doc.bilibili.p3": "请以本门户所发布之链为准，并察其来源。",
    "notice.doc.x.p1": "为备工作室公开联络之道，今公告 kqdhysj工作室 X 平台帐号资讯如下。",
    "notice.doc.x.p2Before": "X 平台帐号入口为：",
    "notice.doc.x.p2After": "。用者可由此入口得公开帐号资讯。",
    "notice.doc.x.p3": "相关平台访问或受网络所限，请以实际开启为准。",
    "notice.doc.facebook.p1": "为补工作室公开联络之道，今公告 kqdhysj工作室 Facebook 联络入口如下。",
    "notice.doc.facebook.p2Before": "Facebook 联络入口为：",
    "notice.doc.facebook.p2After": "。用者可由此入口观公开联络页。",
    "notice.doc.facebook.p3": "涉正式沟通之事，仍宜先由工作室一统联络邮书确认。",
    "notice.doc.sign": "kqdhysj工作室",
    "notice.doc.date": "二〇二六年七月十四日",
    "notice.doc.office": "kqdhysj工作室办公室",
    "notice.doc.printDate": "二〇二六年七月十四日印发",
    "access.desc": "页以语义之构成，兼容 Microsoft 讲述人、Microsoft Edge 朗读及常用辅读之具。",
    "access.card1.title": "辅读",
    "access.card1.body": "启顶部「无碍」具，点「指读」后，鼠标所悬、键盘所至文字、按钮、连结，皆朗其文。",
    "access.card2.title": "长者版",
    "access.card2.body": "增字号，宽行距，广按钮之域，使告示、联络与服务资讯易览。",
    "access.card3.title": "键盘可达",
    "access.card3.body": "可径至正文，焦点明晰，导览与工具按钮皆可由键盘操作。",
    "public.title": "资讯公开",
    "public.desc": "下列资讯，供工作室门户展示及合作往来之用。",
    "public.tableAria": "工作室公开资讯",
    "public.nameLabel": "单位名",
    "public.nameValue": "kqdhysj工作室",
    "public.hostLabel": "主办",
    "public.organizerLabel": "承办",
    "public.typeLabel": "主向",
    "public.typeValue": "glagame、文游、单机游戏、剧情互动体验",
    "public.emailLabel": "联络邮书",
    "public.feedbackEmailLabel": "网站反馈邮书",
    "works.desc": "科幻视觉小说。一舟，二人，一段无人知之事。",
    "works.card1.title": "星河流转时",
    "works.card1.body": "永恒号深空航行第九十七年。林晨自轮值休眠中被强唤醒，十一名管理员屏上，唯其一盏绿灯。能量仅余七成二，飞船漂流。隔离节点中尚有一意识体在线：其妹林汐。彼非 AI。",
    "works.contact": "联络工作室",
    "workDetail.metaTitle": "星河流转时 - kqdhysj工作室资讯入口",
    "workDetail.metaDescription": "kqdhysj工作室游戏《星河流转时 / Where Stars Drift》之详页与 Steam 购取占位资讯。",
    "workDetail.logoAlt": "《星河流转时》游戏之标",
    "workDetail.breadcrumb": "星河流转时",
    "workDetail.noticeLabel": "作品资讯",
    "workDetail.title": "星河流转时",
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.desc": "科幻视觉小说。一舟，二人，一段无人知之事。",
    "workDetail.meta.typeLabel": "作品之类",
    "workDetail.meta.typeValue": "科幻视觉小说 / 单机",
    "workDetail.meta.statusLabel": "开发之况",
    "workDetail.meta.statusValue": "剧本阶段",
    "workDetail.meta.platformLabel": "拟上平台",
    "workDetail.meta.platformValue": "Windows / Steam",
    "workDetail.meta.releaseLabel": "发行之期",
    "workDetail.meta.releaseValue": "待公布",
    "workDetail.meta.developerLabel": "开发",
    "workDetail.meta.developerValue": "kqdhysj工作室",
    "workDetail.meta.publisherLabel": "发行",
    "workDetail.meta.publisherValue": "占位：待定",
    "workDetail.meta.engineLabel": "引擎",
    "workDetail.meta.engineValue": "Ren'Py",
    "workDetail.meta.languageLabel": "语种之助",
    "workDetail.meta.languageValue": "简体中文 / 繁体中文 / 英文 / 日文 / 韩文",
    "workDetail.intro.title": "作品之介",
    "workDetail.intro.p1": "永恒号者，人类首艘跨世代星际移民船也，所向开普勒-186f。航程预计六百年。",
    "workDetail.intro.p2": "第九十七年，管理员林晨自休眠中被强唤醒。飞船漂于深空，余十一管理员及上传者之意识资料皆失，能量仅余七成二。唯一尚在者，隔离节点 7F 中半透明之蓝影，其妹林汐也。其意识于启程前已上传船舰资料库，今为居数位世界之人。",
    "workDetail.intro.p3": "本作为线性分支叙事视觉小说。玩家以管理员林晨之视角，在能量渐耗之飞船中，与数位生命之妹林汐共度倒计时；由对话抉择塑二人关系，每一应答皆暗自累积。",
    "workDetail.features.title": "作品之长",
    "workDetail.feature1": "多结局分支：要害抉择累积 love、hope、guilt 三项隐值，导向四种结局；其一须特定数值组合乃触发。",
    "workDetail.feature2": "沉浸叙事机制：F8 紧急蓝屏伪装、角色知你 Alt+Tab 离窗、系统时辰检生日彩蛋。",
    "workDetail.feature3": "挂机检测：置游戏于后台片时，即有所触发。",
    "workDetail.feature4": "小游戏入剧：以 Ren'Py Screen 系统纳小游戏于剧情中。",
    "workDetail.steam.desc": "Steam 商店页将俟剧本成、美术资产备而后上线。下列皆计划之资，非终定也。",
    "workDetail.steam.statusLabel": "商店之况",
    "workDetail.steam.statusValue": "占位：未公开",
    "workDetail.steam.priceLabel": "预估之价",
    "workDetail.steam.price": "未定（Steam 国区定价）",
    "workDetail.steam.platformLabel": "购取平台",
    "workDetail.steam.platformValue": "Steam",
    "workDetail.steam.dateLabel": "上线之期",
    "workDetail.steam.dateValue": "待公布",
    "workDetail.steam.button": "购取入口待开",
    "workDetail.steam.note": "注：今按钮为占位。游戏尚在开发。",
    "workDetail.actions.back": "返作品陈列",
    "feedback.desc": "受理页中文字之误、链路失效、排版异常、无碍访问等站务反馈。",
    "feedback.emailLabel": "反馈邮书",
    "feedback.scopeLabel": "受理之域",
    "feedback.scopeValue": "错字、失效连结、显示异常、辅读问题、资讯更新之议",
    "feedback.formatLabel": "所宜具陈",
    "feedback.formatValue": "页名、问题所在、问题之说，可附截图或浏览器资讯",
    "feedback.mailAction": "发站务反馈",
    "sitemap.desc": "按栏目汇本站相对连结，并列无碍、反馈与联络入口。",
    "sitemap.group1": "主要栏目",
    "sitemap.mainTitle": "内容入口",
    "sitemap.group2": "服务入口",
    "sitemap.serviceTitle": "服务与公开",
    "sitemap.group3": "访问之助",
    "sitemap.helpTitle": "无碍与反馈",
    "sitemap.group4": "用法",
    "sitemap.accessTitle": "浏览之助",
    "sitemap.accessBody": "可用顶部无碍具启指读、字号调整、高对比与关怀版。",
    "contact.desc": "敬请由下列公开途径联络 kqdhysj工作室。",
    "contact.emailLabel": "邮书",
    "contact.feedbackLabel": "站务反馈",
    "contact.biliLabel": "B 站",
    "contact.biliLink": "入 B 站首页",
    "contact.facebookLink": "开 Facebook 联络页",
    "contact.xLink": "开 X 平台帐号",
    "footer.title": "kqdhysj工作室资讯入口",
    "footer.host": "主办：kqdhysj",
    "footer.organizer": "承办：kqdhysj",
    "contact.emailAction": "寄工作室联络邮书",
    "contact.emailActionAria": "寄工作室联络邮书",
    "contact.feedbackActionAria": "寄站务反馈邮书",
    "footer.linksAria": "站务纠错与站图",
    "home.sidebarAria": "首页侧栏",
    "consult.desc": "可呈项目咨询、作品相关之问及他事。",
    "consult.type": "咨询之类",
    "consult.typePlaceholder": "请择",
    "consult.typeProject": "项目咨询",
    "consult.typeWorks": "作品相关",
    "consult.typeOther": "其他",
    "consult.name": "称谓",
    "consult.contact": "联络之法",
    "consult.contactPlaceholder": "请书电邮或十一位手机号码",
    "consult.contactHelp": "仅收电邮或十一位手机号码。请确其真实可用，否则恐难回复。",
    "consult.contactInvalid": "联络之法格式不合，请书电邮或十一位手机号码。",
    "consult.language": "所望用语",
    "consult.subject": "咨询题",
    "consult.message": "咨询正文",
    "consult.messagePlaceholder": "请略述事由、相关页或作品名、所望解决之事",
    "consult.link": "相关连结",
    "consult.linkPlaceholder": "可不填",
    "consult.replyDeadline": "一百八十日内答复",
    "consult.consent": "吾确认上列内容真实有效，并允 kqdhysj工作室仅以此资讯作联络、咨询处理与站务反馈处理。",
    "consult.submitting": "咨询呈送中，请稍候。",
    "consult.success": "咨询已呈，谢联络 kqdhysj工作室。",
    "consult.error": "呈送未成，请稍后再试，或由电邮入口联络。",
    "consult.ready": "咨询表已备。",
    "footer.email": "联络方式：电邮联络",
    "footer.feedback": "站务反馈：反馈邮书",
    "backtop.aria": "返页首",
    "reader.unsupported": "今浏览器不支网页朗读，可用 Windows 讲述人或 Microsoft Edge 朗读。",
    "senior.enabled": "长者版已启。",
    "senior.disabled": "长者版已闭。",
    "contrast.enabled": "高对比已启。",
    "contrast.disabled": "高对比已闭。",
    "font.increased": "字号已增。",
    "font.decreased": "字号已减。",
    "font.reset": "无碍显示之设已复初。",
    "breadcrumb.current": "今在",
    "breadcrumb.home": "首页",
    "page.backHome": "返首页",
  },
};
...
for (const [language, overrides] of Object.entries(translationCompletionOverrides)) {
  Object.assign(extraTranslationOverrides[language], overrides);
}

Object.assign(translations, {
  ja: makeLanguagePack("en", extraTranslationOverrides.ja),
  ko: makeLanguagePack("en", extraTranslationOverrides.ko),
  lzh: makeLanguagePack("zh-Hans", extraTranslationOverrides.lzh),
});
