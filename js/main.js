...
const translationCompletionOverrides = {
  ja: {
    ...
    "workDetail.meta.engineValue": "Ren'Py",
    "workDetail.intro.p1": "プレースホルダー：この欄では『星河流転時』の世界観、物語背景、中心となる衝突を紹介します。",
    "workDetail.intro.p2": "プレースホルダー：主要人物、章構成、プレイヤーの選択、エンディング分岐を記載します。",
    "workDetail.intro.p3": "プレースホルダー：進行テンポ、テキスト演出、セーブ導線、音楽・美術方針、想定プレイヤーを説明します。",
    "workDetail.feature1": "プレースホルダー：複数章のテキスト物語と重要な選択分岐。",
    "workDetail.feature2": "プレースホルダー：人物関係と時間の流れを軸に進む物語。",
    "workDetail.feature3": "プレースホルダー：スタンドアロンで遊びやすい軽量な操作とセーブ導線。",
    "workDetail.feature4": "プレースホルダー：実績、CG、音楽、複数エンディングの説明を後日追加予定。",
    "workDetail.steam.platformValue": "Steam",
  ...
  ko: {
    ...
    "workDetail.meta.engineValue": "Ren'Py",
    "workDetail.intro.p1": "자리표시자: 이 영역에는 Where Stars Drift의 세계관, 이야기 배경, 핵심 갈등을 소개합니다.",
    "workDetail.intro.p2": "자리표시자: 주요 인물, 장 구성, 플레이어 선택, 엔딩 분기를 설명합니다.",
    "workDetail.intro.p3": "자리표시자: 진행 속도, 텍스트 연출, 저장 흐름, 음악과 미술 방향, 대상 플레이어를 설명합니다.",
    "workDetail.feature1": "자리표시자: 여러 장으로 구성된 텍스트 서사와 핵심 선택 분기.",
    "workDetail.feature2": "자리표시자: 인물 관계와 시간의 흐름을 중심으로 전개되는 이야기.",
    "workDetail.feature3": "자리표시자: 싱글 플레이에 맞춘 가벼운 상호작용과 저장 흐름.",
    "workDetail.feature4": "자리표시자: 업적, CG, 음악, 다중 엔딩 설명은 추후 추가될 수 있습니다.",
    "workDetail.steam.platformValue": "Steam",
    "contact.biliLabel": "B站",
  },
  lzh: {
    ...
    "works.desc": "今陳遊戲《星河流轉時》，其文暫為佔位，後可續補。",
    "works.card1.title": "星河流轉時",
    "works.card1.body": "佔位：遊戲類型待補；故事梗概待補；玩法特色待補；開發情形待補。",
    "works.contact": "聯絡工作室",
    "workDetail.metaTitle": "星河流轉時 - kqdhysj工作室資訊入口",
    ...
    "workDetail.title": "星河流轉時",
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.desc": "此頁陳《星河流轉時》詳情，今為佔位本；後可易以正介、圖像、發行資訊與購取連結。",
    ...
    "workDetail.intro.p1": "佔位：此處當述《星河流轉時》之世界觀、故事本末與核心衝突，使玩家速知其敘事所向。",
    "workDetail.intro.p2": "佔位：此處當補主要人物、章節結構、玩家抉擇與結局分支，後可易以正式宣傳之文。",
    "workDetail.intro.p3": "佔位：此處當明玩法節奏、文本演出、存檔體驗、樂曲美術之向及所適玩家。",
    "workDetail.features.title": "作品之長",
    "workDetail.feature1": "佔位：多章文字敘事，並有要害抉擇之分支。",
    "workDetail.feature2": "佔位：以人物關係與時序流轉推進劇情。",
    "workDetail.feature3": "佔位：輕互動與存檔流程，宜單機遊玩。",
    "workDetail.feature4": "佔位：後可添成就、CG、樂曲與多結局之說。",
