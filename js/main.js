...
const languageMeta = {
  ...
  lzh: { htmlLang: "lzh", intlLang: "zh-Hant", speechLang: "zh-TW" },
};
...
const translations = {
  ...
  en: {
    ...
    "notice.doc.email.p2Before": "The unified email contact entry is: ",
    "notice.doc.email.p2After": ". For project inquiries, information feedback, cooperation communication, and related matters, please use the above entry first.",
    "notice.doc.email.p3": "This notice takes effect from the date of publication.",
    "notice.doc.bilibili.p1": "To help users understand the studio's public homepage information, the Bilibili homepage entry of kqdhysj Studio is hereby disclosed.",
    "notice.doc.bilibili.p2Before": "The Bilibili homepage entry is: ",
    "notice.doc.bilibili.p2After": ". Users may view public homepage information through this entry.",
    ...
    "notice.doc.x.p2Before": "The X account entry is: ",
    "notice.doc.x.p2After": ". Users may obtain public account information through this entry.",
    ...
    "notice.doc.facebook.p1": "To supplement the studio's public contact channels, the Facebook contact entry of kqdhysj Studio is announced as follows.",
    "notice.doc.facebook.p2Before": "The Facebook contact entry is: ",
    "notice.doc.facebook.p2After": ". Users may view the public contact page through this entry.",
...
const translationCompletionOverrides = {
  ja: {
    ...
    "notice.doc.email.p2Before": "統一連絡メール入口：",
    "notice.doc.email.p2After": "。プロジェクト相談、情報フィードバック、協力連絡などは、上記入口を優先してご利用ください。",
    "notice.doc.email.p3": "本通知は公布日から施行します。",
    "notice.doc.bilibili.p1": "ユーザーがスタジオの公開ホームページ情報を確認しやすいよう、kqdhysjスタジオのB站ホームページ入口を公開します。",
    "notice.doc.bilibili.p2Before": "B站ホームページ入口：",
    "notice.doc.bilibili.p2After": "。ユーザーはこの入口から公開ホームページ情報を確認できます。",
    ...
    "notice.doc.x.p2Before": "Xアカウント入口：",
    "notice.doc.x.p2After": "。ユーザーはこの入口から公開アカウント情報を取得できます。",
    "notice.doc.x.p3": "関連プラットフォームの閲覧状況はネットワーク環境の影響を受ける場合があります。実際の表示結果をご確認ください。",
    "notice.doc.facebook.p1": "スタジオの公開連絡窓口を補足するため、kqdhysjスタジオのFacebook連絡入口を次のとおり公告します。",
    "notice.doc.facebook.p2Before": "Facebook連絡入口：",
    "notice.doc.facebook.p2After": "。ユーザーはこの入口から公開連絡ページを確認できます。",
    ...
    "portal.claude.desc": "サードパーティーツールの入口ページです。",
    "guide.card1.tag": "入口",
    "guide.card2.tag": "公告",
    "guide.card3.tag": "公開",
    "guide.card4.tag": "支援",
  ...
  ko: {
    ...
    "notice.doc.email.p2Before": "통합 연락 이메일 입구: ",
    "notice.doc.email.p2After": ". 프로젝트 문의, 정보 피드백, 협력 소통 등은 위 입구를 우선 이용해 주십시오.",
    "notice.doc.email.p3": "본 공지는 게시일부터 시행됩니다.",
    "notice.doc.bilibili.p1": "사용자가 스튜디오 공개 홈페이지 정보를 확인하기 쉽도록 kqdhysj 스튜디오의 B站 홈페이지 입구를 공개합니다.",
    "notice.doc.bilibili.p2Before": "B站 홈페이지 입구: ",
    "notice.doc.bilibili.p2After": ". 사용자는 이 입구를 통해 공개 홈페이지 정보를 확인할 수 있습니다.",
    ...
    "notice.doc.x.p2Before": "X 계정 입구: ",
    "notice.doc.x.p2After": ". 사용자는 이 입구를 통해 공개 계정 정보를 확인할 수 있습니다.",
    "notice.doc.x.p3": "관련 플랫폼 접속 경험은 네트워크 환경의 영향을 받을 수 있으므로 실제 열람 결과를 기준으로 하십시오.",
    "notice.doc.facebook.p1": "스튜디오의 공개 연락 채널을 보충하기 위해 kqdhysj 스튜디오의 Facebook 연락 입구를 다음과 같이 공지합니다.",
    "notice.doc.facebook.p2Before": "Facebook 연락 입구: ",
    "notice.doc.facebook.p2After": ". 사용자는 이 입구를 통해 공개 연락 페이지를 확인할 수 있습니다.",
  ...
  lzh: {
    "language.zhHans": "簡體",
    "weather.cityPlaceholder": "輸城名或擇城",
    "weather.city.shanghai": "上海",
    "weather.city.beijing": "北京",
    "weather.city.guangzhou": "廣州",
    "weather.city.chengdu": "成都",
    ...
    "weather.partlyCloudy": "微雲",
    "weather.overcast": "陰",
    "weather.fog": "霧",
    "weather.drizzle": "細雨",
    "weather.freezingDrizzle": "凍霖",
    "weather.rain": "雨",
    "weather.freezingRain": "凍雨",
    "weather.snow": "雪",
    "weather.snowGrains": "霰",
    "weather.showers": "驟雨",
    "weather.snowShowers": "驟雪",
    "weather.thunderstorm": "雷雨",
    "weather.unknown": "天候未詳",
    "portal.touchgal.category": "文遊之資",
    "portal.touchgal.title": "TouchGAL",
    "portal.touchgal.desc": "galgame 免費下載之所",
    "portal.renpy.category": "創作引擎",
    "portal.renpy.title": "Ren'Py",
    "portal.renpy.desc": "視覺小說與文字遊戲開發之具",
    "portal.steam.category": "遊戲平臺",
    "portal.steam.title": "Steam 線上商店",
    "portal.steam.desc": "單機與獨立遊戲購取之所",
    "portal.gequbao.category": "樂曲之具",
    "portal.gequbao.title": "歌曲寶",
    "portal.gequbao.desc": "MP3 樂曲免費下載",
    "portal.photopea.category": "圖像修編",
    "portal.photopea.title": "Photopea",
    "portal.photopea.desc": "線上圖像與 PSD 修編之具",
    "portal.kuro.category": "雲鳴潮",
    "portal.kuro.title": "庫洛官方雲鳴潮",
    "portal.kuro.desc": "可線上游鳴潮。",
    "portal.pgyer.category": "安卓應用",
    "portal.pgyer.title": "GO 安裝器",
    "portal.pgyer.desc": "安 Google 服務套件。",
    "portal.claude.category": "檢驗之具",
    "portal.claude.title": "Claude 中國用戶檢驗",
    ...
    "quick.tag7": "索引",
    "news.more": "更多",
    "news.item1": "門戶已歸 glagame、文遊、單機之向",
    "news.item2": "無礙欄既開，支指讀與長者版",
    "news.item4": "主辦、承辦之資訊已公示",
    "notice.title": "告示",
    "notice.detail": "公文詳覽",
    "notice.tocAria": "告示目錄",
    "notice.formatLabel": "格式所本：",
    "notice.formatStandard": "GB/T 9704-2012《黨政機關公文格式》",
    "notice.documentsAria": "告示公文詳覽",
    "notice.consult": "諮詢",
    "notice.item1": "公布工作室一統聯絡郵書之告",
    "notice.item2": "公開 B 站首頁入口之說",
    "notice.item3": "公開 X 平臺帳號資訊之告",
    "notice.item4": "公開 Facebook 聯絡途徑之告",
    "notice.doc.issuer": "kqdhysj工作室文件",
    "notice.doc.number1": "kqdhysj發〔2026〕一號",
    "notice.doc.number2": "kqdhysj發〔2026〕二號",
    "notice.doc.number3": "kqdhysj發〔2026〕三號",
    "notice.doc.number4": "kqdhysj發〔2026〕四號",
    "notice.doc.recipients": "諸關注者、合作諸方：",
    "notice.doc.email.p1": "為一工作室資訊發布與合作溝通之道，俾用者、玩家及合作諸方得準確聯絡 kqdhysj工作室，今公布工作室一統聯絡郵書如下。",
    "notice.doc.email.p2Before": "一統聯絡郵書入口為：",
    "notice.doc.email.p2After": "。凡項目諮詢、資訊反饋、合作溝通等事，請先由上列入口聯絡。",
    "notice.doc.email.p3": "本告自發布之日起行。",
    "notice.doc.bilibili.p1": "為便用者知工作室公開主頁資訊，今公開 kqdhysj工作室 B 站主頁入口。",
    "notice.doc.bilibili.p2Before": "B 站主頁入口為：",
    "notice.doc.bilibili.p2After": "。用者可由此入口觀公開主頁資訊。",
    "notice.doc.bilibili.p3": "請以本門戶所發布之鏈為準，並察其來源。",
    "notice.doc.x.p1": "為備工作室公開聯絡之道，今公告 kqdhysj工作室 X 平臺帳號資訊如下。",
    "notice.doc.x.p2Before": "X 平臺帳號入口為：",
    "notice.doc.x.p2After": "。用者可由此入口得公開帳號資訊。",
    "notice.doc.x.p3": "相關平臺訪問或受網絡所限，請以實際開啟為準。",
    "notice.doc.facebook.p1": "為補工作室公開聯絡之道，今公告 kqdhysj工作室 Facebook 聯絡入口如下。",
    "notice.doc.facebook.p2Before": "Facebook 聯絡入口為：",
    "notice.doc.facebook.p2After": "。用者可由此入口觀公開聯絡頁。",
    "notice.doc.facebook.p3": "涉正式溝通之事，仍宜先由工作室一統聯絡郵書確認。",
    "notice.doc.sign": "kqdhysj工作室",
    "notice.doc.date": "二〇二六年七月十四日",
    "notice.doc.office": "kqdhysj工作室辦公室",
    "notice.doc.printDate": "二〇二六年七月十四日印發",
    "access.desc": "頁以語義之構成，兼容 Microsoft 講述人、Microsoft Edge 朗讀及常用輔讀之具。",
    "access.card1.title": "輔讀",
    "access.card1.body": "啟頂部「無礙」具，點「指讀」後，鼠標所懸、鍵盤所至文字、按鈕、連結，皆朗其文。",
    "access.card2.title": "長者版",
    "access.card2.body": "增字號，寬行距，廣按鈕之域，使告示、聯絡與服務資訊易覽。",
    "access.card3.title": "鍵盤可達",
    "access.card3.body": "可徑至正文，焦點明晰，導覽與工具按鈕皆可由鍵盤操作。",
    "public.title": "資訊公開",
    "public.desc": "下列資訊，供工作室門戶展示及合作往來之用。",
    "public.tableAria": "工作室公開資訊",
    "public.nameLabel": "單位名",
    "public.nameValue": "kqdhysj工作室",
    "public.hostLabel": "主辦",
    "public.organizerLabel": "承辦",
    "public.typeLabel": "主向",
    "public.typeValue": "glagame、文遊、單機遊戲、劇情互動體驗",
    "public.emailLabel": "聯絡郵書",
    "public.feedbackEmailLabel": "網站反饋郵書",
    "works.desc": "科幻視覺小說。一舟，二人，一段無人知之事。",
    "works.card1.title": "星河流轉時",
    "works.card1.body": "永恆號深空航行第九十七年。林晨自輪值休眠中被強喚醒，十一名管理員屏上，唯其一盞綠燈。能量僅餘七成二，飛船漂流。隔離節點中尚有一意識體在線：其妹林汐。彼非 AI。",
    "works.contact": "聯絡工作室",
    "workDetail.metaTitle": "星河流轉時 - kqdhysj工作室資訊入口",
    ...
    "workDetail.title": "星河流轉時",
    "workDetail.englishTitle": "Where Stars Drift",
    "workDetail.desc": "科幻視覺小說。一舟，二人，一段無人知之事。",
    "workDetail.meta.typeLabel": "作品之類",
    "workDetail.meta.typeValue": "科幻視覺小說 / 單機",
    "workDetail.meta.statusLabel": "開發之況",
    "workDetail.meta.statusValue": "劇本階段",
    "workDetail.meta.platformLabel": "擬上平臺",
    "workDetail.meta.platformValue": "Windows / Steam",
    "workDetail.meta.releaseLabel": "發行之期",
    "workDetail.meta.releaseValue": "待公布",
    "workDetail.meta.developerLabel": "開發",
    "workDetail.meta.developerValue": "kqdhysj工作室",
    "workDetail.meta.publisherLabel": "發行",
    "workDetail.meta.publisherValue": "佔位：待定",
    "workDetail.meta.engineLabel": "引擎",
    "workDetail.meta.engineValue": "Ren'Py",
    "workDetail.meta.languageLabel": "語種之助",
    "workDetail.meta.languageValue": "簡體中文 / 繁體中文 / 英文 / 日文 / 韓文",
    "workDetail.intro.title": "作品之介",
    "workDetail.intro.p1": "永恆號者，人類首艘跨世代星際移民船也，所向開普勒-186f。航程預計六百年。",
    "workDetail.intro.p2": "第九十七年，管理員林晨自休眠中被強喚醒。飛船漂於深空，餘十一管理員及上傳者之意識資料皆失，能量僅餘七成二。唯一尚在者，隔離節點 7F 中半透明之藍影，其妹林汐也。其意識於啟程前已上傳船艦資料庫，今為居數位世界之人。",
    "workDetail.intro.p3": "本作為線性分支敘事視覺小說。玩家以管理員林晨之視角，在能量漸耗之飛船中，與數位生命之妹林汐共度倒計時；由對話抉擇塑二人關係，每一應答皆暗自累積。",
    "workDetail.features.title": "作品之長",
    "workDetail.feature1": "多結局分支：要害抉擇累積 love、hope、guilt 三項隱值，導向四種結局；其一須特定數值組合乃觸發。",
    "workDetail.feature2": "沉浸敘事機制：F8 緊急藍屏偽裝、角色知你 Alt+Tab 離窗、系統時辰檢生日彩蛋。",
    "workDetail.feature3": "掛機檢測：置遊戲於後臺片時，即有所觸發。",
    "workDetail.feature4": "小遊戲入劇：以 Ren'Py Screen 系統納小遊戲於劇情中。",
    "workDetail.steam.desc": "Steam 商店頁將俟劇本成、美術資產備而後上線。下列皆計畫之資，非終定也。",
    "workDetail.steam.statusLabel": "商店之況",
    "workDetail.steam.statusValue": "佔位：未公開",
    "workDetail.steam.priceLabel": "預估之價",
    "workDetail.steam.price": "未定（Steam 國區定價）",
    "workDetail.steam.platformLabel": "購取平臺",
    "workDetail.steam.platformValue": "Steam",
    "workDetail.steam.dateLabel": "上線之期",
    "workDetail.steam.dateValue": "待公布",
    "workDetail.steam.button": "購取入口待開",
    "workDetail.steam.note": "注：今按鈕為佔位。遊戲尚在開發。",
    "workDetail.actions.back": "返作品陳列",
    "feedback.desc": "受理頁中文字之誤、鏈路失效、排版異常、無礙訪問等站務反饋。",
    "feedback.emailLabel": "反饋郵書",
    "feedback.scopeLabel": "受理之域",
    "feedback.scopeValue": "錯字、失效連結、顯示異常、輔讀問題、資訊更新之議",
    "feedback.formatLabel": "所宜具陳",
    "feedback.formatValue": "頁名、問題所在、問題之說，可附截圖或瀏覽器資訊",
    "feedback.mailAction": "發站務反饋",
    "sitemap.desc": "按欄目彙本站相對連結，並列無礙、反饋與聯絡入口。",
    "sitemap.group1": "主要欄目",
    "sitemap.mainTitle": "內容入口",
    "sitemap.group2": "服務入口",
    "sitemap.serviceTitle": "服務與公開",
    "sitemap.group3": "訪問之助",
    "sitemap.helpTitle": "無礙與反饋",
    "sitemap.group4": "用法",
    "sitemap.accessTitle": "瀏覽之助",
    "sitemap.accessBody": "可用頂部無礙具啟指讀、字號調整、高對比與關懷版。",
    "contact.desc": "敬請由下列公開途徑聯絡 kqdhysj工作室。",
    "contact.emailLabel": "郵書",
    "contact.feedbackLabel": "站務反饋",
    "contact.biliLabel": "B 站",
    "contact.biliLink": "入 B 站首頁",
    "contact.facebookLink": "開 Facebook 聯絡頁",
    "contact.xLink": "開 X 平臺帳號",
    "footer.title": "kqdhysj工作室資訊入口",
    "footer.host": "主辦：kqdhysj",
    "footer.organizer": "承辦：kqdhysj",
    "contact.emailAction": "寄工作室聯絡郵書",
    "contact.emailActionAria": "寄工作室聯絡郵書",
    "contact.feedbackActionAria": "寄站務反饋郵書",
    "footer.linksAria": "站務糾錯與站圖",
    "home.sidebarAria": "首頁側欄",
    "consult.desc": "可呈項目諮詢、作品相關之問及他事。",
    "consult.type": "諮詢之類",
    "consult.typePlaceholder": "請擇",
    "consult.typeProject": "項目諮詢",
    "consult.typeWorks": "作品相關",
    "consult.typeOther": "其他",
    "consult.name": "稱謂",
    "consult.contact": "聯絡之法",
    "consult.contactPlaceholder": "請書電郵或十一位手機號碼",
    "consult.contactHelp": "僅收電郵或十一位手機號碼。請確其真實可用，否則恐難回覆。",
    "consult.contactInvalid": "聯絡之法格式不合，請書電郵或十一位手機號碼。",
    "consult.language": "所望用語",
    "consult.subject": "諮詢題",
    "consult.message": "諮詢正文",
    "consult.messagePlaceholder": "請略述事由、相關頁或作品名、所望解決之事",
    "consult.link": "相關連結",
    "consult.linkPlaceholder": "可不填",
    "consult.replyDeadline": "一百八十日內答覆",
    "consult.consent": "吾確認上列內容真實有效，並允 kqdhysj工作室僅以此資訊作聯絡、諮詢處理與站務反饋處理。",
    "consult.submitting": "諮詢呈送中，請稍候。",
    "consult.success": "諮詢已呈，謝聯絡 kqdhysj工作室。",
    "consult.error": "呈送未成，請稍後再試，或由電郵入口聯絡。",
    "consult.ready": "諮詢表已備。",
    "footer.email": "聯絡方式：電郵聯絡",
    "footer.feedback": "站務反饋：反饋郵書",
    "backtop.aria": "返頁首",
    "reader.unsupported": "今瀏覽器不支網頁朗讀，可用 Windows 講述人或 Microsoft Edge 朗讀。",
    "senior.enabled": "長者版已啟。",
    "senior.disabled": "長者版已閉。",
    "contrast.enabled": "高對比已啟。",
    "contrast.disabled": "高對比已閉。",
    "font.increased": "字號已增。",
    "font.decreased": "字號已減。",
    "font.reset": "無礙顯示之設已復初。",
